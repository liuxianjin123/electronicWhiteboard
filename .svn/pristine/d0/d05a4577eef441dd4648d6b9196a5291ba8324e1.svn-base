                        ...
                        <template>
                          ...
                          >
                            <template slot="tw" slot-scope="text, record">
                              <span
                                :style="{ color: setItemColor(0, record.t) }"
                              >
                                {{ record.t }}
                              </span>
                            </template>
                            <template slot="p" slot-scope="text, record">
                              <span
                                :style="{ color: setItemColor(2, record.p) }"
                              >
                                {{ record.p }}
                              </span>
                            </template>
                            <template slot="r" slot-scope="text, record">
                              <span
                                :style="{ color: setItemColor(1, record.r) }"
                              >
                                {{ record.r }}
                              </span>
                            </template>
...
export default {
  ...
  methods: {
    ...
    async getDataAll() {
      ...
      const res = await this.$axios.get(
        "/han/HandoverProc/GetWhiteBoardHandoverPatients"
      );
  ...
  mounted() {
    //   let a= eval(6+''+this.judgeSymbolType[0]+''+9);
