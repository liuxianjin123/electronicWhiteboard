<template>
  <div  style="height:100%;">
    ...
    <a-menu v-model="current" mode="horizontal">
      <a-menu-item key="ChangeShifts"> <a-icon type="apartment" />人员分组 </a-menu-item>
      <a-menu-item key="ShiftSetting"> 
            <router-link to="/ShiftSetting"><a-icon type="usergroup-delete" />交接班设置</router-link>
      </a-menu-item>
    </a-menu>
    <div class="container">
        ...
        <div class="card_cont" style="overflow: auto;height:100%;padding-bottom: 5%;">
    ...
    <a-modal style="edit_kuang" v-model="visible" width="60%" cancelText='取消' okText='确定' title="新建分组" @ok="handleOk">
